...
/************************* WiFi Access Point *********************************/
#define WLAN_SSID       "Router2"
#define WLAN_PASS       "campus2020"

/************************* Adafruit.io Setup *********************************/o
#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  8883                  
#define AIO_USERNAME    "madhusudan_anand123"
#define AIO_KEY         "64b08bca0d314b2c8c63763ab60ba87f"
...
void setup() {
  ...
  mqtt.subscribe(&bulb);
    mqtt.subscribe(&bulb1);/*it is used subscribe to a topic*/
...
void loop() {
  ...
  if (subscription == &Everything) { /*here the subscribed topics are controlled and the pins and functions are defined */
     ...
     if (subscription == &bulb) {
      Serial.print(F("Got_bulb: "));
      Serial.println((char *)bulb.lastread);
      uint16_t num = atoi((char *)bulb.lastread);
      digitalWrite(D1,num);
    }
